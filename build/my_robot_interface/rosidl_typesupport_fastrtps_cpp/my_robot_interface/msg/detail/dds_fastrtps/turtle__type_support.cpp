...
#include "my_robot_interface/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interface::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interface::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interface::msg::Turtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interface::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interface::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &my_robot_interface::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interface, msg, Turtle)() {
  return &my_robot_interface::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
