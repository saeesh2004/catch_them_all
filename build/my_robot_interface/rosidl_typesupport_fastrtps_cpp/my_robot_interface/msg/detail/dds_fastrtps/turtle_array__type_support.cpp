...
#include "my_robot_interface/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const my_robot_interface::msg::Turtle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  my_robot_interface::msg::Turtle &);
...
cdr_serialize(
  const my_robot_interface::msg::TurtleArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: turtles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      my_robot_interface::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interface::msg::TurtleArray & ros_message)
{
  // Member: turtles
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      my_robot_interface::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        my_robot_interface::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interface::msg::TurtleArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interface::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interface::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &my_robot_interface::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interface, msg, TurtleArray)() {
  return &my_robot_interface::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
