...
static const _Catchturtle_Request_type_support_symbol_names_t _Catchturtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interface, srv, Catchturtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interface, srv, Catchturtle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interface, srv, Catchturtle_Request)() {
  return &::my_robot_interface::srv::rosidl_typesupport_c::Catchturtle_Request_message_type_support_handle;
}
...
static const _Catchturtle_Response_type_support_symbol_names_t _Catchturtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interface, srv, Catchturtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interface, srv, Catchturtle_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interface, srv, Catchturtle_Response)() {
  return &::my_robot_interface::srv::rosidl_typesupport_c::Catchturtle_Response_message_type_support_handle;
}
...
static const _Catchturtle_type_support_symbol_names_t _Catchturtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interface, srv, Catchturtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interface, srv, Catchturtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interface, srv, Catchturtle)() {
  return &::my_robot_interface::srv::rosidl_typesupport_c::Catchturtle_service_type_support_handle;
}
