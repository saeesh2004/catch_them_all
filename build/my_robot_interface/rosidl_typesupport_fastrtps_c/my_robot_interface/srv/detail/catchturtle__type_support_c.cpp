...
#include "my_robot_interface/srv/detail/catchturtle__rosidl_typesupport_fastrtps_c.h"
...
using _Catchturtle_Request__ros_msg_type = my_robot_interface__srv__Catchturtle_Request;
...
size_t get_serialized_size_my_robot_interface__srv__Catchturtle_Request(
  const void * untyped_ros_message,
...
static uint32_t _Catchturtle_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interface__srv__Catchturtle_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interface
size_t max_serialized_size_my_robot_interface__srv__Catchturtle_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interface__srv__Catchturtle_Request;
    is_plain =
      (
...
static size_t _Catchturtle_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interface__srv__Catchturtle_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interface, srv, Catchturtle_Request)() {
...
using _Catchturtle_Response__ros_msg_type = my_robot_interface__srv__Catchturtle_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interface
size_t get_serialized_size_my_robot_interface__srv__Catchturtle_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Catchturtle_Response__ros_msg_type * ros_message = static_cast<const _Catchturtle_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interface__srv__Catchturtle_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interface
size_t max_serialized_size_my_robot_interface__srv__Catchturtle_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interface__srv__Catchturtle_Response;
    is_plain =
      (
...
static size_t _Catchturtle_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interface__srv__Catchturtle_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interface, srv, Catchturtle_Response)() {
...
// already included above
// #include "my_robot_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_robot_interface/srv/catchturtle.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interface, srv, Catchturtle)() {
